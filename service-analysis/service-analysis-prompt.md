...
Claude / ChatGPT / Gemini / Codex 등 어느 LLM에서든 동일한 분석 프레임워크로 작동합니다.

- **Claude**: 시각화를 인라인 위젯으로 렌더링
- **ChatGPT/Codex**: 시각화 지시문을 이미지 또는 텍스트 표로 대체
- **Gemini**: 시각화 지시문을 텍스트 또는 이미지로 처리

트리거: "○○ 분석해줘", "○○ 서비스 어때?", "경쟁사 분석", URL 입력 등
